  ...
  return (
    <main className="overflow-clip h-screen w-screen snap-mandatory snap-y overflow-x-clip overflow-y-scroll over scroll-smooth duration-1000">
      ...
      <section id="1" className="md:snap-end overflow-clip">
        <NavBar />
        <div className="">
          <div className="flex lg:flex-row md:justify-end flex-col md:h-[600px] lg:bg-[url(/hor.gif)] eager bg-[url(/0731.gif)] border-4 border-black bg-no-repeat bg-cover bg-center">
          ...
          <div className="flex flex-col w-full items-center mt-20 md:mt-0">
            ...
            <div className=" md:h-48 w-full items-center flex flex-col lg:flex-row justify-center md:mt-10 p-2 gap-20 lg:gap-5">
              ...
              <div className="md:h-36 md:w-96 items-center justify-center flex">
                {" "}
                <div className="group flex text-xl flex-col items-center w-[300px]  p-6 rounded-lg outline outline-black transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110 duration-300 cursor-pointer">
                  Ar condicionado
                  <div className="group relative w-[150px] mt-3 flex ">
                    <AspectRatio ratio={8 / 4}>
                      <Image
                        src={"/ar2.png"}
                        fill
                  ...
                  <div className="absolute bottom-0 fill-white hidden group-hover:flex flex-row gap-2 justify-center w-full h-8 p-2 bg-black ease-in-out transition duration-700">
                    <a
              ...
              <div className="h-36 w-96 items-center justify-center flex">
                {" "}
                <div className=" group text-xl flex flex-col items-center w-[300px] text-center p-5 rounded-lg outline outline-black transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110 duration-300 cursor-pointer">
      ...
      <footer className="bg-black/95 w-full items-center justify-start overflow-clip flex mt-5 lg:mt-5 md:snap-end flex-col">
        <div className="2xl:w-[1500px] items-center justify-center flex bg-white">
          <div className=" bg-black/95 text-white h-full w-full">
            ...
            <div className="grid p-1 m-1 grid-flow-row grid-cols-1 md:grid-rows-2 md:grid-cols-4">
              ...
              <div>
                ...
                <h3>
                  Endereço Primavera. Rua Guanabara N. 520 Centro, Primavera do
                  Leste - MT
                </h3>
                <h4>(66)3497-3540</h4>
              </div>
              <div>
                ...
                <h3>
                  Av. Sen Antônio Fobtana S/N Jardim C. verde, Campo Verde - MT
                </h3>
                <h4>(66)99982-2726</h4>
              </div>
            </div>
